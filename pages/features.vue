<template>
    ...
    <div class="container text-center pt-5 no-vertical-scrollbar">
    
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        <h2 class="mb-4 display-5 text-center">Our Features</h2>
        <p class="text-secondary mb-5 text-center lead fs-4">Our comprehensive range of services caters to cyclists of all levels, whether you're a casual rider, a commuter, or a seasoned enthusiast.</p>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card border-dark">
                <div class="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 class="mb-4">Brake Adjustment</h4>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card border-dark">
                <div class="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 class="mb-4">Cassette Replacement</h4>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card border-dark">
                <div class="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 class="mb-4">Suspension Tuning</h4>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card border-dark">
                <div class="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 class="mb-4">Frame Alignment</h4>
            ...
            <div class="col-12 col-md-6 col-lg-4 pb-4">
              <div class="card border-dark">
                <div class="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 class="mb-4">Pedal Installation</h4>
